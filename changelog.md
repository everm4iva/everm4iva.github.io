...
- deleted fonts: Knewwave, FleurDeLeah, RampartOne, WDXLLUbrifontSC, RubikMonoOne
- indexed more content! now the new "media" feature is avaliable in (/assets) - see all sources of the website, including fonts, icons, images, etc.
...
- More info about "starl" in sap project + new icon on projects page.
...
> critical
- The whole website design was COOKED! because i left the placeholder music... after i deleted it.

# release 4.3.1 (14 feb 2026)
- Lauched mini player with my fav music!
- Black/Light theme for fonts and icons, yuppie
- Better JavaScript syntax/structure
- Added LICENSE file
- more access points in "/sap"
- "/sap" page now ready to mobile viewport!
- Fixed some missing links and websites on "/r" (resources page)

# release 4.3 (13 feb 2026)
- NEW WEBSITE! umaera.github.io -> everm4iva.github.io

!(function (t, e) {
	...
	const n = (t, e) =>
		...
		i = function (t, e) {
			(void 0 === t && (t = null), void 0 === e && (e = {}), (t = t || o({hash: !0})));
									...
									try {
										for (; !((o = s.next()).done || (n && n())); )
											if ((a = e(o.value)) && a.then) {
												if (!P(a))
													return void a.then(t, r || (r = y.bind(null, (i = new k()), 2)));
												a = a.v;
											}
										i ? y(i, 1, a) : (i = a);
									} catch (t) {
								...
								(function s(a) {
									try {
										for (; ++r < t.length && (!n || !n()); )
											if ((a = e(r)) && a.then) {
												if (!P(a))
													return void a.then(s, i || (i = y.bind(null, (o = new k()), 2)));
												a = a.v;
											}
										o ? y(o, 1, a) : (o = a);
									} catch (t) {
		...
		E = function (t) {
			...
			try {
				...
				if (n) t = Array.from(n);
					...
					return (
						console.warn(`[swup] No elements found matching animationSelector \`${e}\``),
						Promise.resolve()
					);
				const o = t.map((t) =>
					(function (t) {
								...
								try {
									var l = Promise.resolve(c.hooks.call('visit:start', t, void 0)).then(function () {
											...
											try {
												...
												return (
													...
													Promise.resolve(
														o
															? n(o)
															: Promise.resolve(c.fetchPage(t.to.url, e.options)).then(n),
													)
												);
											} catch (i) {
												return Promise.reject(i);
										...
										a.then((e) => {
											...
											(t.advance(5),
												(t.to.html = n),
												(t.to.document = new DOMParser().parseFromString(n, 'text/html')));
										});
								...
								e && !e?.aborted
									? ((t.state = 9),
										...
										(c.options.skipPopStateHandling = () => (
											window.location.assign(t.to.url + t.to.hash),
											!0
										)),
										window.history.back())
									: (t.state = 8);
	...
	function T(t, e, n) {
		if ((void 0 === e && (e = {}), void 0 === n && (n = {}), 'string' != typeof t))
	...
	const j = function (t) {
				...
				return Promise.resolve(
					...
					return Promise.resolve(
						e.hooks.call('animation:out:await', t, {skip: !1}, (t, n) => {
							let {skip: o} = n;
							if (!o) return e.awaitAnimations({selector: t.animation.selector});
						}),
					).then(function () {
		...
		V = function (t) {
			...
			return (
				i &&
					(r = this.hooks.callSync('scroll:anchor', t, {hash: i, options: e}, (t, e) => {
		...
		I = function (t) {
			try {
				...
				const n = e.hooks.call('animation:in:await', t, {skip: !1}, (t, n) => {
					let {skip: o} = n;
					if (!o) return e.awaitAnimations({selector: t.animation.selector});
				});
			...
			try {
				...
				return (
					...
					Promise.resolve(
						...
						return Promise.resolve(
							r.hooks.call('content:scroll', t, void 0, () => r.scrollToContent(t)),
						).then(function () {
							return Promise.resolve(

...
!(function (t, e) {
				...
				(u = new pt[t]()).init(
					...
					u.rawVars
						...
						: (function _processVars(t, e, i, n, a) {
								if ((s(t) && (t = Kt(t, a, e, i, n)), !v(t) || (t.style && t.nodeType) || $(t) || Z(t)))
		...
		Qt = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
			...
			if (
				...
				return isNaN(p * n) || '' === n
					...
					: ((c = new _e(this._pt, t, e, +p || 0, n - (p || 0), 'boolean' == typeof d ? se : ae, 0, _)),
						l && (c.fp = l),
			...
			if (
				...
				for (t._pt = t._ptCache = 0, T = (C && w(T)) || (T && !C), n = 0; n < E.length; n++) {
					...
					(t._op && t._op[n] && t.kill(o, t._op[n]),
						R && t._pt && ((Nt = t), I.killTweensOf(o, c, t.globalTime(e)), (_ = !t.parent), (Nt = 0)),
						t._pt && T && (dt[h.id] = 1));
				}
	...
	var Zt = (function (z) {
		function Tween(e, r, i, n) {
			...
			if (
				((a._targets = A.length
					? ea(A)
					: R('GSAP target ' + e + ' not found. https://greensock.com', !q.nullTargetWarn) || []),
				(a._ptLookup = []),
				(a._overwrite = b),
				x || T || y(_) || y(m))
			) {
					...
					if ($(x))
						...
						for (l in u)
							for (
								...
								(((E = {ease: (S = C[o]).e, duration: ((S.t - (o ? C[o - 1].t : 0)) / 100) * _})[l] =
									S.v),
									s.to(A, E, D),
									(D += E.duration));
				...
				return (
					this.data.forEach(function (t) {
						return t instanceof Context
							...
							: t instanceof Zt && !(t.parent && 'nested' === t.parent.data) && e.push(t);
					}),
					e
				);
			}),
	...
	var Se = {
		...
		exportRoot: function exportRoot(t, e) {
			...
			for (
				...
				((i = r._next),
					(!e && !r._dur && r instanceof Zt && r.vars.onComplete === r._targets[0]) ||
	...
	function Od(t, e) {
		var r = ze.createElementNS
			? ze.createElementNS((e || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'), t)
			: ze.createElement(t);
		...
		if (e.tween && e.tween._time === e.tween._dur) {
			...
			if ('all' === o || !0 === o) ((s.cssText = ''), (i = 1));
				...
				for (n = (o = o.split(',')).length; -1 < --n; )
					((r = o[n]), ar[r] && ((i = 1), (r = 'transformOrigin' === r ? pr : dr)), Xd(a, r));
		...
		yr = function _get(t, e, r, i) {
			...
			return (
				...
				ar[e] && 'transform' !== e
					? ((n = kr(t, i)),
						(n =
							'transformOrigin' !== e ? n[e] : n.svg ? n.origin : Mr(Pd(t, pr)) + ' ' + n.zOrigin + 'px'))
					...
					if ('autoRound' !== c && ((o = e[c]), !pt[c] || !ac(c, e, i, n, t, a)))
						if (
							...
							if (
								...
								if (
									...
									g ||
										...
										((g = this._pt =
											new _e(this._pt, x, dr, 0, 1, v.renderTransform, v, 0, -1)).dep = 1)),
									'scale' === c)
								)
									((this._pt = new _e(
										this._pt,
							...
							if (m || ((u || 0 === u) && (h || 0 === h) && !fr.test(o) && c in x))
								((u = u || 0),
									(d = (s + '').substr((h + '').length)) !==
										(p = Ya(o) || (c in q.units ? q.units[c] : d)) && (h = _d(t, c, s, p)),
									(this._pt = new _e(
										this._pt,
										m ? v : x,
										c,
										h,
										(_ ? ka(h, _ + u) : u) - h,
										m || ('px' !== p && 'zIndex' !== c) || !1 === e.autoRound ? vd : yd,
									)),
									(this._pt.u = p || 0),
